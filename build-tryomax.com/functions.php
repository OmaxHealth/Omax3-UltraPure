...
function getHostingENV($checkENV = NULL){
	...
	$domain = "tryomax.com";
	$cnamePROD = "tryomaxprod.wpengine.com";
	$cnameSTAGE = "tryomaxstage.wpengine.com";
...
function getOfferURL($offerID = NULL){
	$offerURL[1] = "https://tryomax.com/cart/buybutton.php?id=1xUt1bEonE-1nOpgr326PQ";
...
function hide_editor(){
	...
	if(isset($postID)){
		...
		if (get_page_template_slug($postID) == 'page-template-podcast.php'){$show_editor = false;}
