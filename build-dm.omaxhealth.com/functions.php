...
function getHostingENV($checkENV = NULL){
	...
	$domain = "dm.omaxhealth.com";
	$cnamePROD = "dmohprod.wpengine.com";
	$cnameSTAGE = "dmohstage.wpengine.com";
...
function getOfferURL($offerID = NULL){
	$offerURL[1] = "https://dm.omaxhealth.com/cart/buybutton.php?id=y3kxz4_Fi0SYYYCRRRLkSw"; //One-time
	$offerURL[2] = "https://dm.omaxhealth.com/cart/buybutton.php?id=FYwJhHn5ski702gY7HS50Q"; //Subscribe
