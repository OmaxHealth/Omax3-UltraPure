<?php //WordPress Offer Variables
	set_query_var('offer','lp1001');
	set_query_var('custom_body_class','page-lp1001'); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section class="how-it-works">
      ...
      <div class="container">
        ...
        <div class="monthly-supplies">
          <img src="<?php bloginfo('template_directory'); ?>/images/lp1001/how-it-works3.jpg" alt="Omax3 Product">
