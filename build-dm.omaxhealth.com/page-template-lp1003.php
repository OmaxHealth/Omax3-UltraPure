<?php //WordPress Offer Variables
	set_query_var('offer','lp1003');
	set_query_var('custom_body_class','page-lp1003'); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main>
	<section id="hero">
		<div class="container">
			...
			<div class="flexcolumn">
				...
				<div class="product"><img src="<?php bloginfo('template_directory'); ?>/images/lp1003/hero-product.png" srcset="<?php bloginfo('template_directory'); ?>/images/lp1003/hero-product@2x.png 2x" alt="As Seen on TV"/></div>
			</div>
		</div>		
	</section>
		...
		<div class="container">
			<div class="flexbox">
				...
				<div class="box right">
					...
					<div class="ln2">Than other top selling brands</div>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="chart">
		<div class="container">
			...
			<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/chart.png" alt="chart of brands"/>
		</div>
	</section>
		...
		<div class="container">
			<div class="flexbox">
				<div class="box">
					...
					<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/quote-karen.png" alt="Karen"/>
					<div class="person">
				...
				<div class="box">
					...
					<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/quote-anders.png" alt="Anders"/>
					<div class="person">
				...
				<div class="box">
					...
					<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/quote-evan.png" alt="Evan"/>
					<div class="person">
	...
	<section id="doctor">
		<div class="container">
			<div class="flexbox">
				...
				<div class="box">
					<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/doctor-maroon.png" srcset="<?php bloginfo('template_directory'); ?>/images/lp1003/doctor-maroon@2x.png 2x" alt="Dr. Maroon"/>
				</div>
				<div class="box">
					<div class="text">
	...
	<section id="lowerCTA">
		...
		<div class="cta">
			<div class="container">
				<img src="<?php bloginfo('template_directory'); ?>/images/lp1003/lower-cta-product.png" srcset="<?php bloginfo('template_directory'); ?>/images/lp1003/lower-cta-product@2x.png 2x" alt="Free Shipping"/>
				<a class="button" href="https://dm.omaxhealth.com/cart/buybutton.php?id=WtALGd953Uu0Qkv0R2g7ag"><span>Order Now</span></a>
			</div>
		</div>		
	</section>
