...
<header>
    ...
    <div class="container">
        ...
        <!-- End TrustBox widget -->
       <div class="overlay-content">Buy One, Get One Free + 3 Free Gifts*</div>
     </div>
	</div>
  ...
  <main id="main" class="site-main" role="main">
    <section id="masthead">
      <div class="wrapper">
        ...
        <div class="masthead-overlay-info">
          <h3>Buy One, <br /> Get One Free<span class="asterisk">*</span></h3>
    ...
    <section class="starter-kit">
      <div class="wrapper">
        ...
        <p>You get 2 boxes of Omax3 Ultra-Pure, plus high-potency Vitamin D3, a pair of CircuWear Sport Socks and Dr. Maroon's, "Why You Need Fish Oil" eBook &mdash; all shipped free.</p>
        <a href="https://dm.omaxhealth.com/cart/buybutton.php?id=WtALGd953Uu0Qkv0R2g7ag" class="orange-btn" rel="nofollow">Get Started</a>
      </div>
      <img src="<?php bloginfo('template_directory'); ?>/images/starter-kit-bg.png" alt="Starter Kit">
    </section>
    ...
    <section class="stronger">
      <div class="wrapper">
	    ...
	    <div class="wrapper"><a href="https://dm.omaxhealth.com/cart/buybutton.php?id=WtALGd953Uu0Qkv0R2g7ag" class="orange-btn" rel="nofollow">Order Now</a></div>
    </section>
    ...
    <section class="get-started-last">
      <div class="wrapper">
        ...
        <p>Buy One, <br />Get One Free <br />+ 3 Free Gifts*&nbsp;</p>
        <a href="https://dm.omaxhealth.com/cart/buybutton.php?id=WtALGd953Uu0Qkv0R2g7ag" class="orange-btn" rel="nofollow">Get Started</a>
      </div>
    </section>
      </main>
